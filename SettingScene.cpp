...
void SettingScene::Initialize() {
    ...
    btn = new Engine::ImageButton("stage-select/dirt.png", "stage-select/floor.png", halfW * 2.75 / 2, halfH *3.25 /2, 400, 100);
    btn->SetOnClickCallback(std::bind(&SettingScene::PlayOnClick, this, 1));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Back", "pirulen.ttf", 48, halfW * 3.25 / 2, halfH *3.5 /2, 0, 0, 0, 255, 0.5, 0.5));
