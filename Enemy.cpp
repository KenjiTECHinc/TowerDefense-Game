...
void Enemy::OnExplode() { //override this function in individual class to spawn new spawnlings.
...
void Enemy::Spawnling(std::string imgSpawn) {
	Engine::Sprite newSpawn(imgSpawn, Position.x, Position.y);
	std::swap(Sprite::bmp, newSpawn.bmp);
}
